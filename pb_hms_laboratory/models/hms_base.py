...
class PBAppointment(models.Model):
    ...
    lab_request_ids = fields.One2many('pb.laboratory.request', 'appointment_id', string='Lab Requests')
...
class Treatment(models.Model):
    ...
    request_ids = fields.One2many('pb.laboratory.request', 'treatment_id', string='Lab Requests')
