...
export class ConstructionDashboard extends Component {
    ...
    budgetChart = signal.ref();
    statusChart = signal.ref();
    mrChart = signal.ref();
    ragChart = signal.ref();
    ...
    renderCharts() {
        ...
        if (this.budgetChart()) {
            ...
            this.charts.budget = new Chart(this.budgetChart(), {
                type: "bar",
                data: {
        ...
        if (this.statusChart()) {
            ...
            this.charts.status = new Chart(this.statusChart(), {
                type: "doughnut",
                data: {
        ...
        if (this.mrChart()) {
            ...
            this.charts.materialRequests = new Chart(this.mrChart(), {
                type: "bar",
                data: {
                    labels: rows.map((r) => r.label),
        ...
        if (this.ragChart()) {
            ...
            this.charts.rag = new Chart(this.ragChart(), {
                type: "doughnut",
                data: {
