...
class HMSPortal(CustomerPortal):
    ...
    def _prepare_portal_layout_values(self):
        ...
        values.update({
            'patient_id': request.env.user.pb_patient_id,
        })
        return values
    ...
    def my_appointments(self, page=1, sortby=None, **kw):
        ...
        return request.render("pb_hms_portal.my_appointments", values)
    ...
    def my_appointments_appointment(self, appointment_id=None, access_token=None, **kw):
        ...
        return request.render("pb_hms_portal.my_appointments_appointment", {'appointment': record_sudo})
    ...
    def my_prescriptions(self, page=1, sortby=None, **kw):
        ...
        return request.render("pb_hms_portal.my_prescriptions", values)
    ...
    def my_appointments_prescription(self, prescription_id=None, access_token=None, **kw):
        try:
            ...
            return request.redirect('/my')
        return request.render("pb_hms_portal.my_prescriptions_prescription", {'prescription': record_sudo})
    ...
    @http.route(['/pb/cancel/<int:appointment_id>/appointment'], type='http', auth="user", website=True, sitemap=False)
    ...
    def my_evaluations(self, page=1, sortby=None, **kw):
        ...
        return request.render("pb_hms_portal.my_evaluations", values)
    ...
    def my_evaluation(self, evaluation_id=None, access_token=None, **kw):
        try:
            record_sudo = self._document_check_access('pb.patient.evaluation', evaluation_id, access_token=access_token)
        except (AccessError, MissingError):
            return request.redirect('/my')
        return request.render("pb_hms_portal.my_evaluation", {'evaluation': record_sudo})
    ...
    def my_evaluation_create(self, **kw):
        ...
        return request.render("pb_hms_portal.create_evaluation", values)
    ...
    def my_evaluation_charts(self, **kw):
        ...
        return request.render("pb_hms_portal.my_evaluation_charts", values)
    ...
    def get_default_form_data(self):
        ...
        relations = request.env['pb.family.relation'].sudo().search([])
    ...
    def family_member_new_form(self, redirect=None, **kw):
        ...
        return request.render("pb_hms_portal.create_family_member", values)

    @http.route('/pb/hms/family/create', type="http", auth="user", website=True, csrf=True, sitemap=False)
    def create_family_member(self, **kwargs):
        ...
        request.env['pb.family.member'].sudo().create({
    ...
    def family_member_update_form(self, family_memebr_id, redirect=None, **kw):
        ...
        return request.render("pb_hms_portal.update_family_member", values)
