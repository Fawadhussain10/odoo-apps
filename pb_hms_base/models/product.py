...
class ProductProduct(models.Model):
    ...
    def _pb_get_partner_price(self, quantity=1, uom_id=False, partner=False):
...
class product_template(models.Model):
    ...
    dosage_uom_id = fields.Many2one('uom.uom', string='Unit of Dosage', domain="['|', ('id', '=', product_uom_category_id), ('relative_uom_id', '=', product_uom_category_id)]")
