...
class Flavour(models.Model):
    ...
    _name_pb_medi_flavour_uniq = models.Constraint('unique (name)', 'The name of the Content must be unique !')
...
class PBActiveComp(models.Model):
    _name = 'active.comp'
...
class PBDrugCompany(models.Model):
    _name = 'drug.company'
...
class PBDrugRoute(models.Model):
    _name = 'drug.route'
