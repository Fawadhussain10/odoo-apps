...
import { Component, onMounted, onWillDestroy, onWillStart, proxy, signal, t, useProps } from "@odoo/owl";
...
export class PbPatientMap extends Component {
    ...
    // Mounted both as a client action (with the action service props) and as
    // an embedded <PbPatientMap compact="true"/> inside the dashboard.
    props = useProps({
    ...
    setup() {
        ...
        this.state = proxy({ loading: true, totalPatients: 0, locatedCount: 0 });
