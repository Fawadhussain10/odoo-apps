...
class PBAppointment(models.Model):
    ...
    def _pb_get_attachemnts(self):
        attachments = super(PBAppointment, self)._pb_get_attachemnts()
    ...
    radiology_request_ids = fields.One2many('pb.radiology.request', 'appointment_id', string='Radiology Requests')
    ...
    def action_radiology_request(self):
        ...
        action['views'] = [(self.env.ref('pb_radiology.patient_radiology_test_request_form').id, 'form')]
        return action
...
class Treatment(models.Model):
    ...
    radiology_request_ids = fields.One2many('pb.radiology.request', 'treatment_id', string='Radiology Requests')
