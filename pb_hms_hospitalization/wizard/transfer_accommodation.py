...
class TransferAccommodation(models.TransientModel):
    ...
    hospitalization_id = fields.Many2one('pb.hospitalization', 'Hospitalization', required=True)
    ...
    def default_get(self,fields):
        ...
        hospitalization = self.env['pb.hospitalization'].browse(context.get('active_ids', []))
        res.update({
