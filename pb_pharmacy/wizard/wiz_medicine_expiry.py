...
class PbMedicineExpiry(models.TransientModel):
    _name = "pb.medicine.expiry"
    _description = "Pb Medicine Expiry"
    ...
    def print_pdf_report(self):
        return self.env.ref('pb_pharmacy.pb_medicine_expiry_report_action').report_action(self)
