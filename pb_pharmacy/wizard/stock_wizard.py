...
class StockReturnPicking(models.TransientModel):
    ...
    def print_report(self):
        ...
        datas['form'] = res
        return self.env.ref('pb_pharmacy.action_stock_picking_barcode').report_action([], data=datas)


class StockProductionReport(models.TransientModel):
    _name = 'stock.production.report'
    _description = "PB Stock Production Report"
    ...
    def print_report(self):
        ...
        res = res and res[0] or {}
        datas['form'] = res
        return self.env.ref('pb_pharmacy.action_stock_product_barcode').report_action([], data=datas)
