...
class PBPatient(models.Model):
    ...
    _ean13_uniq = models.Constraint('UNIQUE(barcode)', 'Barcode must be unique!')
...
class HmsAppointment(models.Model):
    ...
    _inherit = ['hms.appointment', 'pb.hms.barcode.scan.mixin']
...
class PrescriptionOder(models.Model):
    ...
    _inherit = ['prescription.order', 'pb.hms.barcode.scan.mixin']
...
class HmsTreatment(models.Model):
    _name = 'hms.treatment'
    _inherit = ['hms.treatment', 'pb.hms.barcode.scan.mixin']
