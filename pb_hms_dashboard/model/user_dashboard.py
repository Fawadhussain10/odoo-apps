...
class ResUsers(models.Model):
    ...
    birthday_color = fields.Char(string='Birthday Color', default="#059669")

    #Receptionist Dashboard fields
    total_patients = fields.Integer(compute="_compute_dashboard_data")
    total_patients_color = fields.Char(string='Total Patient Color', default="#0D9488")
    ...
    total_treatments_color = fields.Char(string='Total Treatments Color', default="#059669")

    total_appointments = fields.Integer(compute="_compute_dashboard_data")
    total_appointments_color = fields.Char(string='Total Appointments Color', default="#D97706")
    ...
    total_open_invoice_color = fields.Char(string='Open Invoices', default="#E11D48")

    total_shedules = fields.Integer(compute="_compute_dashboard_data")
    total_shedules_color = fields.Char(string='Total Shedules Color', default="#4F46E5")

    appointment_bar_graph = fields.Text(compute='_compute_dashboard_data')
    appointment_bar_graph_color = fields.Char(string='Patient Barchart Color', default="#0D9488")
    patient_line_graph = fields.Text(compute='_compute_dashboard_data')
    patient_line_graph_color = fields.Char(string='Patient Linechart Color', default="#4F46E5")
    ...
    my_total_patients_color = fields.Char(string='My Total Patient Color', default="#0D9488")
    my_total_appointments = fields.Integer(compute="_compute_dashboard_data")
    my_total_appointments_color = fields.Char(string='My Total Appointments Color', default="#D97706")
    my_avg_wait_time = fields.Char(compute="_compute_dashboard_data")
    my_avg_cons_time = fields.Char(compute="_compute_dashboard_data")
    my_avg_time_color = fields.Char(string='My Avg Time Color', default="#4F46E5")
    ...
    physicians_color = fields.Char(string='Total Physicians Color', default="#0891B2")
