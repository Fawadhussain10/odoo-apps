...
class Digest(models.Model):
    ...
    def _get_kpi_custom_settings(self, company, user):
        ...
        res['kpi_action']['kpi_pb_certification_total'] = 'pb_certification.action_certificate_management?menu_id=%s' % self.env.ref('pb_certification.menu_certificate_management').id
        return res