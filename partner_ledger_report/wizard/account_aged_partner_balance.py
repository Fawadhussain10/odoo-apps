...
class AccountAgedPartnerBalance(models.TransientModel):
    ...
    def print_report_aged_partner(self):
        ...
        if not self._context.get('report_type') == 'excel':
            return self.env.ref('partner_ledger_report.action_aged_partner_balance_report').with_context(
            ...
            col = 0
            count = 1
            report_values = self.env['report.partner_ledger_report.report_agedpartnerbalance']._get_report_values(
                self, data=data)
