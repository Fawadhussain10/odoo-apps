 ...
 * triggers the server-side onchange of pb.invoice.barcode.scan.mixin.
 */
export class PbInvoiceBarcodeHandlerField extends Component {
    static template = xml``;
...
registry.category("fields").add("pb_invoice_barcode_handler", { component: PbInvoiceBarcodeHandlerField });
