...
class PBHms(http.Controller):
    ...
    def labresult_details(self, labresult_unique_code, **post):
        if labresult_unique_code:
            ...
            if labresult:
                return request.render("pb_laboratory.pb_labresult_details", {'labresult': labresult})
...
class HMSPortal(CustomerPortal):
    ...
    def my_lab_results(self, page=1, sortby=None, **kw):
        ...
        return request.render("pb_laboratory.lab_results", values)
    ...
    def my_lab_test_result(self, result_id=None, access_token=None, **kw):
        ...
        return request.render("pb_laboratory.my_lab_test_result", {'lab_result': order_sudo})
    ...
    def my_lab_requests(self, page=1, sortby=None, **kw):
        ...
        return request.render("pb_laboratory.lab_requests", values)
    ...
    def my_lab_test_request(self, request_id=None, access_token=None, **kw):
        try:
            order_sudo = self._document_check_access('pb.laboratory.request', request_id, access_token=access_token)
        except (AccessError, MissingError):
            return request.redirect('/my')

        return request.render("pb_laboratory.my_lab_test_request", {'lab_request': order_sudo})
