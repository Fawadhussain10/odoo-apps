...
class Appointment(models.Model):
    ...
    def onchange_patient_id(self):
        ...
        if self.patient_id:
            subscription = self.env['pb.hms.subscription'].sudo().search([('state','=','active'),('res_model_id.model','=','hms.appointment'),('patient_id','=',self.patient_id.id)], limit=1)
...
class PBPatient (models.Model):
    ...
    subscription_ids = fields.One2many("pb.hms.subscription", "patient_id", "Subscriptions")
