...
class Digest(models.Model):
    ...
    def _get_kpi_custom_settings(self, company, user):
        ...
        res['kpi_action']['kpi_pb_appointment_total'] = 'pb_hms.action_appointment?menu_id=%s' % self.env.ref('pb_hms.action_main_menu_appointmnet_opd').id
        res['kpi_action']['kpi_pb_treatment_total'] = 'pb_hms.pb_action_form_hospital_treatment?menu_id=%s' % self.env.ref('pb_hms.main_menu_treatment').id
        res['kpi_action']['kpi_pb_procedure_total'] = 'pb_hms.action_pb_patient_procedure?menu_id=%s' % self.env.ref('pb_hms.menu_pb_patient_procedure_treatment').id
        res['kpi_action']['kpi_pb_evaluation_total'] = 'pb_hms.action_pb_patient_evaluation'
        res['kpi_action']['kpi_pb_patients_total'] = 'pb_hms_base.action_patient?menu_id=%s' % self.env.ref('pb_hms_base.main_menu_patient').id
        return res