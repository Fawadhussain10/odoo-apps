...
class ResCompany(models.Model):
    ...
    pb_check_appo_payment = fields.Boolean(string="Check Appointment Payment Status before Accepting Request")
    ...
    pb_prescription_qrcode = fields.Boolean(string="Print Authetication QrCode on Presctiprion", default=True)
    pb_auto_appo_confirmation_mail = fields.Boolean(string="Sent Appointment Confirmation Mail")
    pb_appointment_planned_duration = fields.Float(string="Default Appointment Planned Duration", default=0.25)

    pb_reminder_day = fields.Float(string="Reminder Days")
    pb_reminder_hours = fields.Float(string="Reminder Hours")

    pb_flag_days = fields.Integer(string="Warning Flag Days", help="Days to count cancelled appointment", default=365)
    pb_flag_count_limit = fields.Integer(string="Count Limit for Flag", help="Configure number to show alert flag after couting that many cancelled appoitments", default=10)
