...
class PbCancelReasonWiz(models.TransientModel):
    _name = 'pb.cancel.reason.wiz'
    _description = "Cancellation Reason"

    cancel_reason_id = fields.Many2one('pb.cancel.reason', string='Cancellation Reason', required=True)
