...
class PBAppointment(models.Model):
    ...
    surgery_ids = fields.One2many('hms.surgery', 'appointment_id', string='Surgeries', groups="pb_hms_surgery.group_pb_hms_surgery_user")
    surgery_count = fields.Integer(compute='_rec_surgery_count', string='# Surgeries', groups="pb_hms_surgery.group_pb_hms_surgery_user")
...
class PBPatient(models.Model):
    ...
    surgery_ids = fields.One2many('hms.surgery', 'patient_id', string='Surgery', groups="pb_hms_surgery.group_pb_hms_surgery_user")
    surgery_count = fields.Integer(compute='_rec_count', string='# Surgery', groups="pb_hms_surgery.group_pb_hms_surgery_user")
...
class Physician(models.Model):
    ...
    surgery_count = fields.Integer(compute='_rec_sur_count', string='# Surgery', groups="pb_hms_surgery.group_pb_hms_surgery_user")
