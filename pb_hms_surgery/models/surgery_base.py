...
class PBMedicamentLine(models.Model):
    ...
    medicine_uom_id = fields.Many2one('uom.uom', string='Unit', help='Amount of medication (eg, 250 mg) per dose', domain="['|', ('id', '=', product_uom_category_id), ('relative_uom_id', '=', product_uom_category_id)]")
