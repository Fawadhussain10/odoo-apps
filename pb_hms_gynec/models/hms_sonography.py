...
class AppointmentSonographyPelvis(models.Model):
    ...
    def print_sono_elvis_report(self):
        self.ensure_one()
        return self.env.ref('pb_hms_gynec.action_report_sono_pelvis').report_action(self)
...
class AppointmentSonographyFollical(models.Model):
    ...
    def print_sono_follical_report(self):
        self.ensure_one()
        return self.env.ref('pb_hms_gynec.action_report_sono_follical').report_action(self)
...
class AppointmentSonographyObstetric(models.Model):
    ...
    def print_sono_obstetric_report(self):
        self.ensure_one()
        return self.env.ref('pb_hms_gynec.action_report_sono_obstetric').report_action(self)
