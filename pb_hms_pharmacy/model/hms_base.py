...
class Prescription(models.Model):
    ...
    invoice_id = fields.Many2one('account.move', string='Invoice', copy=False, groups="account.group_account_invoice,stock.group_stock_user")
    ...
    def pb_prescription_inv_product_data(self):
    ...
    def create_invoice(self):
        product_data = self.pb_prescription_inv_product_data()
    ...
    def pb_create_delivery(self):
        ...
        return self.pb_view_delivery()

    def pb_view_delivery(self):
...
class AccountMove(models.Model):
    ...
    #PB: Stock move is not linked with related prescription line becase line is not even linked with invoice
    @api.model 
