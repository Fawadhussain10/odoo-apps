...
class CertificateManagement(models.Model):
    ...
    _inherit = ['certificate.management', 'pb.qrcode.mixin', 'portal.mixin']
...
class PBPatient(models.Model):
    ...
    certificate_ids = fields.One2many('certificate.management', 'patient_id', string='Certificates', groups="pb_certification.group_certificate_manager")
    certificate_count = fields.Integer(compute='_rec_count', string='# Certificates')

    def action_open_certificate(self):
        action = self.env["ir.actions.actions"]._for_xml_id("pb_certification.action_certificate_management")
...
class HmsAppointment(models.Model):
    ...
    certificate_ids = fields.One2many('certificate.management', 'appointment_id', string='Certificates', groups="pb_certification.group_certificate_manager")
