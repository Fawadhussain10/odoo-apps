...
class Appointmentschedule(models.Model):
    ...
    def _get_booking_price(self):
        for rec in self:
            ...
            rec.appointment_price = product._pb_get_partner_price()
...
class AppointmentscheduleSlot(models.Model):
    ...
    _slot_date_unique = models.Constraint('UNIQUE(slot_date, schedule_id)', 'Appointment slot must be unique!')
