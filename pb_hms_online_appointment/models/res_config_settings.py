...
class ResCompany(models.Model):
    ...
    pb_appointment_tc = fields.Char('Terms & Conditions Page link', default="/appointment/terms")
    pb_allowed_video_consultation = fields.Boolean("Allowed Online Consultation", help="Allowed Online Consultation")
...
class ResConfigSettings(models.TransientModel):
    ...
    pb_appointment_tc = fields.Char(related='company_id.pb_appointment_tc',
        string='Terms & Conditions Page link', readonly=False)
    pb_allowed_video_consultation = fields.Boolean(related='company_id.pb_allowed_video_consultation', 
