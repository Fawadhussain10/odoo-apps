...
class PbCreateVaccinations(models.TransientModel):
    _name = "pb.plan.vaccinations"
    ...
    def default_get(self,fields):
        ...
        res = super(PbCreateVaccinations, self).default_get(fields)
    ...
    def create_vaccinations(self):
        Vaccination = self.env['pb.vaccination']
